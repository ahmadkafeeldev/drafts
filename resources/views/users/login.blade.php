        ...
        <div class="max-w-md w-full">
          ...
          <div class="p-8 rounded-2xl bg-white shadow">
            ...
            <form class="mt-8 space-y-4" action="{{ route('user.public_notice') }}">
              ...
              <div class="!mt-8">
                <button type="button" id="login" class="w-full py-3 px-4 text-sm tracking-wide rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                  Sign in
                </button>
              </div>
              <p class="text-gray-800 text-sm !mt-8 text-center">Don't have an account? <a href="{{ route('user.signup') }}" class="text-blue-600 hover:underline ml-1 whitespace-nowrap font-semibold">Register here</a></p>
            </form>
          </div>
        </div>
      </div>
