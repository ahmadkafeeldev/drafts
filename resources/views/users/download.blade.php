        ...
        <ul class="list-decimal p-8">
            <li>
                <p class="text-base leading-relaxed">
                    Traffic or Highway Authority issues the order hereby {{ $booking->notice_type }} has made the above-named Traffic Order under section {{ $booking->order_under_section }} of the Road Traffic Regulation Act 1984 for the purpose specified in paragraph 2.
                </p>
            </li>
